...
public class ConditionDisplayV4 implements Observer, DisplayElement {
    private float temperature;
    private float humidity;
    private float pressure;
    final Observable observable;

    public ConditionDisplayV4(Observable observable) {
    ...
    @Override
    public void display() {
        System.out.println("condition display"+temperature+"_"+humidity+"_"+pressure);
    }
